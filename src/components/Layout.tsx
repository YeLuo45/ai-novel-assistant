...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-dark-bg dark:bg-dark-bg">
      ...
      {!isMobile && (
        <header className="bg-dark-bg dark:bg-dark-bg-secondary border-b border-dark-border dark:border-dark-border px-4 py-3 safe-top">
                ...
                <Link
                  ...
                  className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                    isActive('/projects') || location.pathname.startsWith('/projects/')
                      ...
                      : 'text-gray-600 dark:text-gray-300 hover:bg-dark-bg-secondary dark:hover:bg-gray-800'
                  }`}
                >
                  项目
                </Link>
      ...
      {/* Mobile Header */}
      {isMobile && (
        <header className="bg-dark-bg dark:bg-dark-bg-secondary border-b border-dark-border dark:border-dark-border px-4 py-3 safe-top sticky top-0 z-30">
      ...
      {isMobile && (
        <div className={`fixed inset-y-0 left-0 z-50 w-72 bg-dark-bg dark:bg-dark-bg-secondary transform transition-transform duration-300 ${
          ...
          {currentProject && (
            <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-dark-border dark:border-dark-border bg-dark-bg dark:bg-dark-bg-secondary">
...
function MobileBottomNav({ projectId }: { projectId: string }) {
  ...
  return (
    <nav className="mobile-bottom-nav fixed bottom-0 left-0 right-0 bg-dark-bg dark:bg-dark-bg-secondary border-t border-dark-border dark:border-dark-border flex justify-around items-center z-30 safe-bottom">
      {tabs.map(tab => {
